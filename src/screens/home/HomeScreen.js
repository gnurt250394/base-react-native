...
/*utils*/
import styles from '../ArtistScreen/style';
import Utils from '../../utils';
/*Data*/
import artistData from '../../assets/data/SongData'
import coverImage from '../../assets/images/bob-marley-cover.jpg'
import profileImage from '../../assets/images/bob-marley-profile.jpg'
...
export default class HomeScreen extends Component {
    ...
    _getHeaderBackgroundColor = () => {
        ...
        return scrollY.interpolate({
            inputRange: [0, 140],
            outputRange: ['rgba(0,0,0,0.0)', Utils.Color.HEADER_COLOR],
            extrapolate: 'clamp',
    ...
    _getImageLeftPosition = () => {
        ...
        return scrollY.interpolate({
            inputRange: [0, 80, 140],
            outputRange: [Utils.ThemeUtils.relativeWidth(30), Utils.ThemeUtils.relativeWidth(38), Utils.ThemeUtils.relativeWidth(10)],
            extrapolate: 'clamp',
            useNativeDriver: true
        });
    };
    ...
    _getImageTopPosition = () => {
        ...
        return scrollY.interpolate({
            inputRange: [0, 140],
            outputRange: [Utils.ThemeUtils.relativeHeight(20), Platform.OS === 'ios' ? 8 : 10],
            extrapolate: 'clamp',
            useNativeDriver: true
        });
    };
    ...
    _getImageWidth = () => {
        ...
        return scrollY.interpolate({
            inputRange: [0, 140],
            outputRange: [Utils.ThemeUtils.relativeWidth(40), Utils.ThemeUtils.APPBAR_HEIGHT - 20],
            extrapolate: 'clamp',
            useNativeDriver: true
        });
    };
    ...
    _getImageBorderColor = () => {
        ...
        return scrollY.interpolate({
            inputRange: [0, 140],
            outputRange: [Utils.Color.CARD_BG_COLOR, 'rgba(0,0,0,0.0)'],
            extrapolate: 'clamp',
            useNativeDriver: true
        });
    };
    ...
    _getListViewTopPosition = () => {
        ...
        return scrollY.interpolate({
            inputRange: [0, 250],
            outputRange: [Utils.ThemeUtils.relativeWidth(100) - Utils.ThemeUtils.APPBAR_HEIGHT - 10, 0],
            extrapolate: 'clamp',
            useNativeDriver: true
        });
    };
    ...
    render() {
        ...
        return (
            <View style={styles.container}>
                <StatusBar barStyle={'light-content'} backgroundColor={Utils.Color.STATUSBAR_COLOR}/>
                ...
                <Animated.View style={[styles.headerStyle, {
                    ...
                    <View style={styles.headerLeftIcon}>
                        <Icons name={"arrow-left"} size={25} color={Utils.Color.HEADER_BACK_ICON_COLOR}/>
                    </View>

                    <View style={styles.headerRightIcon}>
                        <Icons name={"settings"} size={25} color={Utils.Color.HEADER_BACK_ICON_COLOR}/>
                    </View>
                ...
                <Animated.Image
                    style={
                        [styles.profileImage, {
                            ...
                            borderRadius: (Utils.ThemeUtils.APPBAR_HEIGHT - 20) / 2,
